...
export default function Hero() {
    return (
        <section
            ...
            {/*        />*/}
            {/*</motion.div>*/}
            <motion.div className="w-[82%] rounded-full min-h-[560px] p-10 absolute top-[52%] left-[50%] -translate-x-1/2 z-9 -translate-y-1/2 flex gap-2 bg-[radial-gradient(circle,rgba(36,28,19)_0%,rgba(36,28,19)_49%,rgba(36,28,19,0.4)_100%)] blur-3xl">
